...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<form action="" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">姓名:</td><td  align="left"><input type="text" name="username" value="${findApply.username}" readonly="readonly"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">开始时间:</td><td  align="left">${findApply.begintime}</td>
								</tr>
								<tr >
									<td align="right" width="30%">结束时间:</td><td  align="left">${findApply.endtime}</td>
								</tr>
								<tr >
									<td align="right" width="30%">请假天数:</td><td  align="left"><input type="text" name="days" value="${findApply.days}" readonly="readonly"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">请假原因:</td>
									<td  align="left">
										<textarea rows="15" cols="50" name="cause" readonly="readonly">${findApply.cause}</textarea>
									</td>
								</tr>
								<tr >
									<td align="right" width="30%">审核人:</td><td  align="left"><input type="text" name="days" value="${findApply.approver}" readonly="readonly"/></td>
								</tr>
		
								<tr >
									<td align="center" colspan="2"><br/><input type="button"  value="审核通过" onclick="passAudit(${findApply.id})"/>
									<input type="button"  value="审核不通过" onclick="unaudit(${findApply.id})" /></td>
								</tr>
	...
	<script type="text/javascript">
		function passAudit(id){
			location.href="${pageContext.request.contextPath}/Vacation/passAudit?id="+id;
		}
		function unaudit(id){
			location.href="${pageContext.request.contextPath}/Vacation/unAudit?id="+id;
		}
	</script>
</html>
