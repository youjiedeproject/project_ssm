...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<form action="saveApply" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">姓名:</td><td  align="left"><input type="text" name="username" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">开始时间:</td><td  align="left"><input type="text" name="begintime" id="d11" class="Wdate" onClick="WdatePicker()"  /></td>
								</tr>
								<tr >
									<td align="right" width="30%">结束时间:</td><td  align="left"><input type="text"  name="endtime" class="Wdate" onClick="WdatePicker()" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">请假天数:</td><td  align="left"><input type="text" name="days" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">请假原因:</td>
									<td  align="left">
										<textarea rows="15" cols="50" name="cause"></textarea>
									</td>
								</tr>
								<tr >
									...
									<td  align="left">
											...
											<c:forEach items="${applicant}" var="ap">
											<option value="${ap.username}">${ap.username}</option>
											</c:forEach>
											</select>
									</td>
								</tr>
								...
								<tr >
									<td align="center" colspan="2"><br/><input type="submit"  id="send" value="提交审核"  />
									<input type="button"  value="返回" onclick="returnBy()" /></td>
								</tr>
	...
	<script type="text/javascript">
		function returnBy(){
			location.href="${pageContext.request.contextPath}/Vacation/checkvacation";
		}
	</script>
</html>
