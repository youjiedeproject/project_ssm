...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="nav" id="nav">
					...
					<dl >
						...
						<dd>
							<a href="javascript:void(0)" target="_self" target="_self">个人账户</a>
						</dd>
						<c:if test="${SessionUser.isadmin == 1}">
						<dd>
							<a href="${pageContext.request.contextPath}/Manage/" target="_self">管理账户</a>
						</dd>
						</c:if>
					</dl>
				</div>
					...
					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr >
									<td align="right" width="30%">密码:</td><td  align="left"><input type="text" name="password" value="${SessionUser.password}" readonly="readonly" id="age"/></td>
								</tr>
								<tr >
									<td align="center" colspan="2"><br/><input type="button"  id="save" value="编辑数据" onclick="compile()" /></td>
								</tr>
	...
	function compile(){
		location.href = "${pageContext.request.contextPath}/Manage/compileUser";
	}
