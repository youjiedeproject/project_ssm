...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<form action="sendEmail" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<c:forEach items="${vacation1}" var="ue">
								<tr >
									<td  width="15%">${ue.username}</td>
									<td  width="15%">
										${ue.begintime}
									</td>
									<td  width="15%">
									...
									<td  width="15%">
										<c:if test="${ue.state =='未审核'}">
											<a href="${pageContext.request.contextPath}/Vacation/audit/${ue.id}">[审核]</a>
										</c:if>
									</td>
								</tr>
								</c:forEach>
								...
								<input type="button" value="申请休假" onclick="applyBy()">
							</form>
							</div>
					</div>	
			</div>
	...
	<script type="text/javascript">
		function applyBy(){
				location.href="${pageContext.request.contextPath}/Vacation/applyvacation.do";
		}
	</script>
</html>
