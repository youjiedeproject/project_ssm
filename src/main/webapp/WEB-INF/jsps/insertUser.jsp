...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<form action="saveUser" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">用户名:</td><td  align="left"><input type="text" name="username" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">密码:</td><td  align="left"><input type="text" name="password" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">昵称:</td><td  align="left"><input type="text" name="nicename" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">年龄:</td><td  align="left"><input type="text" name="age" /></td>
								</tr>
								<tr >
								...
								<tr >
									<td align="right" width="30%">手机：</td><td  align="left"><input type="text" name="phone" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">地址：</td><td  align="left"><input type="text" name="address" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">职位：</td><td  align="left">
								...
								<tr >
									...
									<input type="button"  id="save" value="返回" onclick="back()" /></td>
								</tr>
	...
	function back(){
		location.href="${pageContext.request.contextPath}/Manage/manageUser";
	}
