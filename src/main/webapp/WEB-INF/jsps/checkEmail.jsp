...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="nav" id="nav">
					...
					<div class="action">
						...
						<div class="pages">
						<form action="${pageContext.request.contextPath}/Email/download" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								
								<tr >
									<td align="right" width="30%">邮箱标题:</td><td  align="left"><input type="text" name="title" value="${getEmail.title}" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">邮件内容:</td>
									<td  align="left">
										<textarea rows="15" cols="50"  name="content" >${getEmail.content}</textarea>
									</td>
								</tr>
								<tr >
									<td align="right" width="30%">发送时间:</td><td  align="left">${getEmail.time}</td>
								</tr>
								<tr >
									<td align="right" width="30%">来自:</td><td  align="left"><input type="text" name="fname" value="${getEmail.fname}" /></td>
								</tr>
								<tr >
									<td align="right" width="30%"></td><td  align="left"><input type="hidden" name="filename" value="${getEmail.filename}" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">文件下载:</td><td  align="left"><input type="submit"  value="下载" /></td>
								</tr>
								<tr>
									<td align="right" width="30%"></td><td  align="left"><input type="hidden" name="filePath" value="${getEmail.file}" /></td>
								</tr>
								<tr >
