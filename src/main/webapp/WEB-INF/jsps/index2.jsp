...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">昵称：</td><td  align="left"><input type="text" name="nicename" value="${SessionUser.nicename}" readonly="readonly" id="nickname"/></td>
								</tr>
								<tr >
	...
	function setit(){
		location.href = "${pageContext.request.contextPath}/user/compile";
	}
