...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="nav" id="nav">
					...
					<dl>
						...
						<dd>
							<a href="javaScipt:void(0)" target="_self">垃圾邮件</a>
						</dd>
					</dl>
					<dl>
						<dt
						...
						<form action="sendEmail" method="post" id="myForm">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr >
									...
									<td  width="15%">
										<a href="javascript:void(0)" onclick="deleteRemail(${ue.id})">删除</a>|<a href="${pageContext.request.contextPath}/Email/restory.do/${ue.id}">还原</a>
									</td>
								</tr>
								</c:forEach>
	...
	function deleteRemail(id){
		var conf=confirm("确定要删除吗？");
		if(conf){
			location.href="${pageContext.request.contextPath}/Email/deleteRemail?id="+id;
		}
	}
	</script>
</html>
