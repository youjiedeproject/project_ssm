...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="action">
						...
						<form action="updateUser" method="post">	
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr >
									<td align="center" ><br/><input type="submit"  id="save" value="保存数据"  /></td>
									<td align="center" ><br/><input type="button"   value="返回" onclick="back()" /></td>
								</tr>
	...
	function back(){
		location.href="${pageContext.request.contextPath}/Manage/checkUser";
	}
